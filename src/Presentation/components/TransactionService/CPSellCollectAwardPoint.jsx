...
import {GetSellerAwardPoint, ModifySellerAwardPoint} from '../../../Application/redux/actions/TransactionServiceAction';
...
const CPsellcollectawardpoint = () => {
    const dispatch = useDispatch();
    const sellCollectAwardPoint = useSelector(state => state.SellerAwardPoint);
    
    const {awardPointUsing, histories} = sellCollectAwardPoint;
    ...
    const OnRefresh = useCallback(
        () => {
            ...
            setAwardPoint(sellCollectAwardPoint);
        },
        [sellCollectAwardPoint],
    )

    const OnApply = () => {
        const title = "Thay đổi điểm thưởng cho người bán";
        const message = "Bạn có chắc chắn sẽ thay đổi điểm thưởng cho người bán";
        dispatch(
            ShowConfirmDialog(title, message,  ModifySellerAwardPoint(AwardPoint)) 
        )
    }
                        ...
                        <Card className="shadow">
                            <CardHeader>
                                <Row className="align-items-center">
                                    <Col lg="9">
                                        <h3 className="mb-0">Điểm Thưởng Người Bán</h3>
                                    </Col>
                                </Row>
                            </CardHeader>
                            <CardBody>
...
export default CPsellcollectawardpoint;
